...
<img width="1536" height="1024" alt="insite" src="https://github.com/user-attachments/assets/dc5380d7-537c-49c4-90e1-63ffaee851df" />
...
Visit `http://localhost:8080`, it connects to the WebSocket server and
renders your house.

You'll want to replace the placeholder house geometry in `app.js` with
your actual floorplan (a simple extruded-wall SVG-to-3D export, or a
basic room-by-room box layout, works fine to start — doesn't need to be a
...
- [ ] Real floorplan geometry in the frontend
